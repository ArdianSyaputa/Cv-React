  ...
  return (
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-lg text-center">
        <h2 class="text-3xl font-bold sm:text-4xl">Silahkan Baca Selengkapnya di bawah ini</h2>
      ...
      <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <h2 class="mt-4 text-xl font-bold text-white">BUFF NO1.</h2>
  
          <p class="mt-1 text-sm text-gray-300">
          buff lebih penting daripada teman dan victory
          </p>
        </a>
      ...
      <div class="mt-12 text-center">
        <a
          href="https://m.mobilelegends.com/id"
        ...
        >
          <span class="text-sm font-medium"> Info Lengkap </span>
